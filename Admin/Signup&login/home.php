            ...
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto h-100">
                        <li class="nav-item">
                            <a class="nav-link active" href="http://localhost/webproject/Admin/Signup&login/home.php">
                        ...
                        <li class="nav-item dropdown">
                        <a class="nav-link" href="file:///D:/xampp/htdocs/Webproject/Admin&User/Front%20page.html">
