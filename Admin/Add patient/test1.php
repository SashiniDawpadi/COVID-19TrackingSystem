...
?>
<tr>
<th scope='row'><input type="checkbox" name="patient[]" value="<?php echo $row["id"]; ?>" ></th>
...
?>
            ...
            <button class="btn btn-primary btn-block text-uppercase" name="delete" value="Delete" onClick="setDeleteAction();">
              Delete selected patients details
            </button>
