...
$usersCount = count($_POST["patient"]);
for($i=0;$i<$usersCount;$i++) {
mysqli_query($conn, "UPDATE patient set name='" . $_POST["name"][$i] . "', age='" . $_POST["age"][$i] . "',gender='" . $_POST["gender"][$i] . "',quarantine='" . $_POST["quarantine"][$i] . "', center='" . $_POST["center"][$i] . "', identifieddate='" . $_POST["identifieddate"][$i] . "' WHERE id='" . $_POST["id"][$i] . "'");
}
                  ...
                  <div class="row">
                      <div class="form-group mb-3 col-xs-12 col-sm-6">
                          ...
                          <input
                            ...
                            name="identifieddate"
                            type="text"
                            value = "<?php echo $row[$i]['identifieddate']; ?>"
                            class="form-control validate"
